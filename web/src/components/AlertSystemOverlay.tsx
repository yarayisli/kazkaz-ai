    ...
    <>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-mono font-extrabold uppercase px-1.5 py-0.2 rounded-xs ${
                          isCritical ? 'bg-red-500 text-white' : 'bg-amber-500 text-black font-bold'
                        }`}>
                          {isCritical ? 'KRİTİK UYARI' : 'BÜTÇE RİSKİ'}
                        </span>
                        <span className="text-xs font-mono text-slate-400">{toast.timestamp}</span>
                      </div>
                ...
                <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-xs font-mono">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="text-xs font-bold text-[#FF4D00] hover:text-white flex items-center gap-1 transition-colors cursor-pointer"
                    >
                      <span>Teşhis Et</span>
                    ...
                    <button
                      ...
                      className="bg-white/10 hover:bg-white/20 text-white font-bold text-xs px-2.5 py-1 rounded-xs flex items-center gap-1 transition-colors cursor-pointer border border-white/15"
                    >
      ...
      <div className="fixed bottom-4 left-4 right-4 z-40 flex items-center justify-end gap-2 sm:bottom-6 sm:left-auto sm:right-6">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="bg-white text-[#FF4D00] text-xs font-black px-1.5 py-0.2 rounded-xs font-mono ml-1">
              {unreadCount}
            </span>
          )}
        </button>
                  ...
                  <div className="flex items-center justify-between pt-1 font-mono text-xs">
                    ...
                    {unreadCount > 0 && (
                      <button
                        ...
                        className="text-xs text-[#FF4D00] hover:underline cursor-pointer font-bold"
                      >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 no-scrollbar">
                  ...
                  {showSimulationTools && <div className="p-3 bg-white/[0.03] rounded-xs border border-white/10 space-y-2">
                    <div className="flex items-center justify-between text-xs font-mono text-slate-300">
                      ...
                      <span className="text-xs text-slate-500">Özel Efekt Simülasyonu</span>
                    </div>

                    <div className="grid grid-cols-2 gap-2 font-mono text-xs">
                      <button
                        onClick={() => triggerBudgetTestAlert('Pazarlama & Reklam', 185000)}
                        className="bg-red-950/60 hover:bg-red-900/80 text-red-200 border border-red-800/60 py-2 px-2.5 rounded-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer text-xs"
                      >
                      ...
                      <button
                        ...
                        className="bg-amber-950/60 hover:bg-amber-900/80 text-amber-200 border border-amber-800/60 py-2 px-2.5 rounded-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer text-xs"
                      >
                    ...
                    <button
                      ...
                      className="w-full bg-white/5 hover:bg-white/10 text-slate-200 border border-white/15 py-1.5 px-3 rounded-xs text-xs font-mono transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                        ...
                        >
                          ...
                          <div className="pt-2 border-t border-white/10 flex items-center justify-between text-xs font-mono">
                            <button
                              ...
                              className="text-[#FF4D00] hover:underline font-bold text-xs flex items-center gap-1 cursor-pointer"
                            >
                              <Zap className="w-3 h-3" />
                            ...
                            <button
                              ...
                              className="bg-white/10 hover:bg-white/20 text-white px-2.5 py-1 rounded-xs text-xs font-bold flex items-center gap-1 cursor-pointer"
                            >
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-white/5 p-3 rounded-xs border border-white/10 font-mono">
                    <span className="text-xs text-slate-400 block">TESPİT EDİLEN ETKİ TUTARI</span>
                  ...
                  <div className="bg-white/5 p-3 rounded-xs border border-white/10 font-mono">
                    <span className="text-xs text-slate-400 block">UYARI DÜZEYİ & EŞİK</span>
            ...
            >
              ...
              <div className="space-y-4 font-mono text-xs">
                <div>
                  ...
                  <span className="text-xs text-slate-500">Harcama bütçeyi %{thresholds.budgetOverrunPercent} aştığında bildirim verilir.</span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-500">Nakit akışı tek ayda ₺{thresholds.cashflowDropTRY.toLocaleString('tr-TR')} düştüğünde ikaz verilir.</span>
                </div>
              </div>
